export function mountCreateModal({ posts = [], onAddPost, onClose }) {
  ...
  fileLabel.innerHTML = `
    <img src="/frendz/icons/plus.svg" alt="Upload" class="h-12 w-12 mb-3 opacity-50" />
  ...
  removeButton.innerHTML = '<img src="/frendz/icons/close.svg" alt="Remove" class="h-5 w-5" />';
