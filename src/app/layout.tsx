...
export const metadata: Metadata = {
  ...
  description:
    "A multidisciplinary design studio specializing in visual design, spatial design, films, games, and books. We transform creative visions into tangible experiences.",
  keywords: [
    "design studio",
    "visual design",
    "spatial design",
  ...
  openGraph: {
    ...
    description:
      "A multidisciplinary design studio specializing in visual design, spatial design, films, games, and books.",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=BBH+Sans+Bartle&family=Baloo+2:wght@400..800&family=Fredoka:wght@300..700&display=swap"
          rel="stylesheet"
        />
        <link
