...
export function Header() {
  ...
  const fetchLogoSettings = async () => {
    try {
      ...
      if (
        columnData &&
        (columnData.logo_light_url ||
          columnData.logo_dark_url ||
          columnData.logo_url)
      ) {
        setLogoSettings({
          logo_light_url:
            columnData.logo_light_url || columnData.logo_url || "/Anomaly.png",
          logo_dark_url:
            columnData.logo_dark_url || columnData.logo_url || "/Anomaly.png",
      ...
      setLogoSettings({
        logo_light_url:
          settings.logo_light_url || settings.logo_url || "/Anomaly.png",
        logo_dark_url:
          settings.logo_dark_url || settings.logo_url || "/Anomaly.png",
              ...
              <div className="min-h-screen p-6 md:p-12 bg-transparent">
                ...
                <div className="flex items-center justify-between mb-12">
                  <Link
                    ...
                    className="relative h-[53px] w-auto"
                  >
                    <Image
                      src={
                        resolvedTheme === "dark"
